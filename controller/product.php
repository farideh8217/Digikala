...
class product extends controller
{
    ...
    public function index($id)
    {
        ...
        $gallery = $this->model->get_question($id);
        $data = ['productinfo'=>$productinfo,'onlyclicksite'=>$onlyclicksite,'color_product'=>$color_product,'garantee_product'=>$garantee_product,'gallery'=>$gallery];
