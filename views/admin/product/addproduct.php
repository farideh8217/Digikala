...
تصویر:
            ...
            <php  if (isset($productInfo['title'])) { ?>
                <div style="width: 220px;height: 220px;display: inline-block;float: left;
                    background:url(public/images/products/<=php $productInfo['id'] ?>/product_220.jpg)"></div>
            <php  } ?>
...
انتخاب رنگ:
            ...
            foreach ($colorsInfo as $row) {
                ?>
                <span style="background:<=php $row['hex']; ?>" class="span_item"><input type="hidden"
                                                                                      value="<=php $row['id']; ?>"
                                                                                      name="color[]"><=php $row['title']; ?>
...
انتخاب گارانتی
        :
            ...
            foreach ($garanteesInfo as $row) {
                ...
                <span class="span_item"><input type="hidden" value="<=php $row['id'] ?>"
                                               name="garantee[]"><=php $row['title'] ?><img
