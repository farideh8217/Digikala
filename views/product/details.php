                ...
                foreach ($gallery as $row) {
                    if ($row['threed'] == 0) {
                        ...
                        <li data-main-image="public/images/products/<=php $row['idproduct'] ?>/gallery/large/<=php $row['img']; ?>">
                            <img
                                src="public/images/products/<=php $row['idproduct'] ?>/gallery/small/<=php $row['img']; ?>"
                                style="width: 60px;">
                        </li>
                    <php  }
                } ?>
...
تومان
            ...
            <div id="compare">
                    ...
                    <span style="cursor: pointer;" class="yekan addtocart_btn" onclick="addToBasket('<=php $productInfo['id'] ?>')">
                        <i></i>
                        افزودن به سبد
                    </span>
